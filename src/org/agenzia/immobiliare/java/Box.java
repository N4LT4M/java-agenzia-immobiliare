...
Creare una classe Main con metodo main nel quale testare tutte le funzionalità delle classi
    ...
    //costruttore
    public Box(String alphanumericCode, String address, int cap, String city, int surfaceAreaSquareMeters, int parkingSpaces) {
    ...
    public String toString() {
        return toString() + getAlphanumericCode()+ " " + getAddress() + " " + getCap() + " " + getCity() + " " + getSurfaceAreaSquareMeters() + " " + parkingSpaces;
    }
     */
    @Override
    public String toString() {
        return super.toString() + " " + parkingSpaces;
    }
}
